...
extern void computeEOS(size_t, size_t, Tm mui, const Thydro* gamma, const Tu*, const Tm*, const Thydro*, const Thydro*,
...
extern void
driftPositionsGpu(const GroupView& grp, float dt, float dt_back, util::array<float, Timestep::maxNumRungs> dt_m1, Tc* x,
                  Tc* y, Tc* z, Thydro* vx, Thydro* vy, Thydro* vz, const Tm1* x_m1, const Tm1* y_m1, const Tm1* z_m1,
...
extern void computePositionsGpu(const GroupView& grp, float dt, util::array<float, Timestep::maxNumRungs> dt_m1, Tc* x,
                                ...
                                Thydro* mui, Thydro* gamma, Thydro muiConst, Thydro gammaConst,
